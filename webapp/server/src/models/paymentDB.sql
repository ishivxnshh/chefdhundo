...
CREATE TABLE IF NOT EXISTS public.payments (
    ...
    razorpay_order_id TEXT, -- Added for Razorpay migration
    razorpay_payment_id TEXT, -- Added for Razorpay migration
    razorpay_signature TEXT, -- Added for Razorpay migration
